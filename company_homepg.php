...
<?php
    ...
    if(isset($_SESSION['error1'])){
        ...
        echo "<div class='alert alert-danger'>Select only sort by interview or application order</div>";
...
<body>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" 		background = "#aaaaaa"
...
<div style="display: flex;">
  <div style="flex: 1;">
    <label for="sort_order2">Sort by application date:</label><br>
            ...
            // Check if a sort order was selected
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <td>                            
                        <a href="http://localhost:8300/?title=<?php echo urlencode($row['title']) ?> " class="link-dark" ><i class="fa-solid fa-trash"></i></a>
                        </td>  
                        <!-- view all info -->
                        <td>
