...
<br><br>
  ...
  <select name="sort" id="sort" onchange="this.form.submit()">
    ...
    <option value="sector_asc">Sector (Ascending)</option>
    <option value="sector_desc">Sector (Descending)</option>
  </select>
</form>
  ...
  <tbody>
    <?php           
        ...
        error_reporting(E_ERROR | E_PARSE);
           ...
           if(isset($_POST['sort'])){
            $sort_field = isset($_POST['sort']) ? $_POST['sort'] : '';
          
            // Default query
            $sql = "SELECT * FROM jobs WHERE id='$id'";
          
            // Add sorting clause based on selected sort field
            if ($sort_field == 'date_asc') {
              $sql .= " ORDER BY interdate ASC";
            } elseif ($sort_field == 'date_desc') {
              $sql .= " ORDER BY interdate DESC";
            } elseif ($sort_field == 'sector_asc') {
              $sql .= " ORDER BY sector ASC";
            } elseif ($sort_field == 'sector_desc') {
