...
include 'config.php';
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST"){
   if (isset($_POST['submit'])){
     ...
     if (!$uppercase || !$lowercase || !$number || !$specialchars || strlen($pwd1) < 8){
       ...
       $_SESSION['dob'] = $dob;
       $_SESSION['pwd1'] = $pwd1;
       $query = "INSERT INTO alumni (name,rollno,degree,branch,email,phno,yop,dob,password) VALUES ('$username','$rollno','$degree','$branch','$email','$phno','$yop','$dob','$pwd1')";
 ...
 <html lang="en">
   ...
   <a class="navbar-brand" href="#">IITP Training and Placement Portal Register Page</a>
 ...
 <div class="container mt-4">
   ...
   <select class="form-select" aria-label="Default select example" name="degree" style = "height: 32px;">
     ...
     <option value="MSC">MSC</option>
       ...
       <div class="col">
         <label>Branch</label>
         <input type="text" class="form-control" id="branch" placeholder="Enter Your Branch" aria-label="First name" name="branch">
       </div>
       <div class="col">
 ...
 <div class="hint-text">Already have an account? <a href="http://localhost:2008/">Login here</a></div>
